...
const GridMyLife = () => {
  ...
  const [userName, setUserName] = useState(
    () => localStorage.getItem("gml_user") || "Anshul Gora",
  );
  ...
  return (
    ...
    >
      ...
      >
        <div className="inline-block min-w-full align-middle">
          <table className="min-w-full border-collapse">
            ...
            <tbody
              className={`divide-y ${isDarkMode ? "divide-[#2F2F2F]" : "divide-gray-200"}`}
            >
              {habits.map((habit) => (
                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          className={`w-full h-10 flex items-center justify-center cursor-pointer ${isChecked ? (isDarkMode ? "bg-green-900/20" : "bg-green-50") : ""}`}
                        >
                          {isChecked && (
      ...
      {/* 4. Footer Section */}
      <footer className="max-w-7xl mx-auto mb-10">
